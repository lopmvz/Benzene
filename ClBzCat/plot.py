...
#stcksx4 = stcks4[:,0] 
#stcksy4 = stcks4[:,1]
data11 = np.genfromtxt('clbzcat_unrel.txt')
#ip11 = 2911.85
stcksx11 = data11[:,0] 
stcksy11 = (data11[:,1])
data11 = np.genfromtxt('clbzcat_unrel.dat')
x11 = data11[:,0] 
y11 = (data11[:,1])

#
data22 = np.genfromtxt('clbzcat_rel.txt')
#ip22 = 291.90
stcksx22 = data22[:,0] 
stcksy22 = (data22[:,1])
data22 = np.genfromtxt('clbzcat_rel.dat')
x22 = data22[:,0] 
y22 = (data22[:,1])
...
plt.plot(x1+x1shift, y1,'crimson', label='ClBz', linewidth=2)
plt.plot(x11+x1shift, y11, 'darkblue', label='ClBz$^+$ (unrelaxed)', linewidth=2)#, linestyle='--')
plt.plot(x22+x1shift, y22, 'green', label='ClBz$^+$ (relaxed)', linewidth=2)#, linestyle='--')
...
plt.savefig('ClBzCat_NEXAFS.pdf')
plt.show()
