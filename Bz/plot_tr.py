...
plt.plot(x4+x1shift, y4, 'y', label='1\B$_{2u}$', linewidth=2)
plt.plot(x2+x1shift, y2*1, 'darkblue', label='1\B$_{1u}$', linewidth=2)
#plt.plot(x3+x1shift, y3*1, 'g', label='S2 ($\pi\pi^*$)  x 10', linewidth=2)
plt.plot(x3+x1shift, y3*2, 'g', label='2\B$_{2u}$ + 2\B$_{3u}$', linewidth=2)
