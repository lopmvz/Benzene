...
ax1.plot(x2+x1shift, y2*1, 'darkblue', label='1\A$_{1}$', linewidth=2)
#ax1.plot(x3+x1shift, y3*1, 'g', label='S2 ($\pi\pi^*$)  x 10', linewidth=2)
ax1.plot(x3+x1shift, y3*1, 'g', label='1\B$_{1}$', linewidth=2)
#ax1.plot(x4+x1shift, y4*1, 'g', label='S2 ($\pi\pi^*$)  x 10', linewidth=2)
ax1.plot(x4+x1shift, y4*1, 'y', label='1\B$_{2}$', linewidth=2)
...
n=len(stcksx3)
for i in range(n):
    ax1.plot([stcksx3[i]+x1shift,stcksx3[i]+x1shift],[0,stcksy3[i]*1],'green',linewidth=1.0)
n=len(stcksx4)
for i in range(n):
